...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // المتغيرات الفنية الجديدة
  bool isScanningStarted = false; 
  bool isDarkMode = false; // التحكم في الوضع الليلي
  TorchState torchState = TorchState.off; // التحكم في الفلاش
  final MobileScannerController cameraController = MobileScannerController(); // متحكم الكاميرا والفلاش

  // سجل لمنع التكرار (المادة_رقم_الطالب)
  final Set<String> _scannedRecords = {};

  // حساب عدد الطلاب المرصودين للمادة الحالية فقط
  ...
  Widget build(BuildContext context) {
    // تطبيق السمة (Theme) ديناميكياً بناءً على اختيار المستخدم
    return Theme(
          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                tooltip: isDarkMode ? "تفعيل الوضع العادي" : "تفعيل الوضع الليلي",
              ),
            ],
          ),
          body: Column(
            children: [
              // ================= القسم العلوي الأول: العداد ورفع الملف =================
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    // 2. المربع النصي الذكي في أعلى اليسار لرصد عدد الطلاب المدخلين
                    Container(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isDarkMode ? Colors.white70 : Colors.deepPurple.shade900
                            ),
                          ),
                          Text(
                            "$currentSubjectCount",
                            style: TextStyle(
                              fontSize: 18, 
                              fontWeight: FontWeight.bold, 
                              color: isDarkMode ? Colors.amber : Colors.deepPurple.shade700
                            ),
                          ),
                        ],
                      ),
              ...
              // ================= قائمة اختيار المادة والكود (تظهر بعد رفع الملف) =================
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: isScanningStarted && excelFilePath != null
                        ? Stack(
                            children: [
                              // الكاميرا مع الملقم والمتحكم الخاص بها لضبط الفلاش
                              MobileScanner(
                              ...
                              // زر التحكم بالفلاش العائم فوق الكاميرا
                              Positioned(
                                top: 10,
                                left: 10,
                                child: CircleAvatar(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                excelFilePath == null 
                                  ...
                                  : "تم إعداد الكنترول بنجاح.\nاضغط على 'بدء المسح الذكي' بالأسفل لتنشيط الفحص الجداري الكاميرا.",
  ...
  @override
  // إغلاق مستودع ومتحكم الكاميرا عند الخروج للحفاظ على عمر بطارية الهاتف السامسونج
  void dispose() {
